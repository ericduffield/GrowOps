...
class ACommand:
    ...
    def __init__(self, target: Type, raw_message_body: Union[dict, str]) -> None:
        ...
        #if raw message body is dict
        if(raw_message_body is dict):
            self.data: dict = raw_message_body
        else:
